...
function showRecipes(specifcIndex) {
    ...
    document.getElementById("myRecipes").innerHTML +=
        "<div class=\"card mt-5\">\n                    <div class=\"card-body\" id=\"".concat(recipesManager.recipes[indexToDisplay].id, "\">\n                    <div class=\"row\">\n                    <div class=\"col-6\">\n                      <h5 class=\"card-title\">").concat(recipesManager.recipes[indexToDisplay].name, "</h5></div>\n                      \n                    <div class=\"col-6 d-flex justify-content-end\">\n                    <button class=\"btn btn-outline-warning text-center rounded-5\" style=\" min-height: 40px; max-height: 40px;\n                 id=\"nextButton\" onclick=\"showRecipes()\"><i class=\"fa-solid fa-arrow-right\"></i></button>  </div>\n                      <h6 class=\"d-lg-flex card-subtitle mb-2 text-body-secondary justify-content-between align-items-bottom\">Peparation time : ").concat(recipesManager.recipes[indexToDisplay].prepTime, "\n                        \n                      </h6>\n                        <div class=\"row\">\n                    <div class=\"col-md-4\">\n                    <div class=\"display-6 fs-4 my-3 text-center\">\n                    Instructions\n                  </div>\n                  <ul class=\"list-group list-group-flush\">\n                    <li class=\"list-group-item text-center\" style=\"max-height:60px; overflow:hidden\">").concat(recipesManager.recipes[indexToDisplay].instructions[0], "</li>\n                    <li class=\"list-group-item text-center\"style=\"max-height:60px; overflow:hidden\">").concat(recipesManager.recipes[indexToDisplay].instructions[1], "</li>\n                    <li class=\"list-group-item text-center\"style=\"max-height:60px; overflow:hidden\">").concat(recipesManager.recipes[indexToDisplay].instructions[2], "</li>\n                  </ul>\n                  </div>\n                  <div class=\"col-md-4\">\n                        <div class=\"display-6 fs-4 my-3 text-center\">\n                      Ingrediants\n                    </div>\n                    <ul class=\"list-group list-group-flush\">\n                      <li class=\"list-group-item text-center\">").concat(recipesManager.recipes[indexToDisplay].ingredients[0].name, ", ").concat(recipesManager.recipes[indexToDisplay].ingredients[0].amount, "</li>\n                      <li class=\"list-group-item text-center\">").concat(recipesManager.recipes[indexToDisplay].ingredients[1].name, ", ").concat(recipesManager.recipes[indexToDisplay].ingredients[1].amount, "</li>\n                      <li class=\"list-group-item text-center\">").concat(recipesManager.recipes[indexToDisplay].ingredients[2].name, ", ").concat(recipesManager.recipes[indexToDisplay].ingredients[2].amount, "</li>\n                    </ul>\n                    </div>\n                  <div class=\"col-md-4\">\n                  <div class=\"display-6 fs-4 my-3 text-center\">\n                  Utencils\n                </div>\n                <ul class=\"list-group list-group-flush\">\n                  <li class=\"list-group-item text-center\">").concat(recipesManager.recipes[indexToDisplay].utensils[0], "</li>\n                  <li class=\"list-group-item text-center\">").concat(recipesManager.recipes[indexToDisplay].utensils[1], "</li>\n                  <li class=\"list-group-item text-center\">").concat(recipesManager.recipes[indexToDisplay].utensils[2], "</li>\n                </ul>\n                </div>\n                \n                      <button class=\"card-link btn btn-outline-warning w-100 rounded-3 text-left mt-3\" onclick=\"cookThis('").concat(recipesManager.recipes[indexToDisplay].id, "')\">Lets Cook</button>\n                      </div>\n                      </div>\n                  </div>");
...
function showIngredientsInLists() {
    ...
    for (var _i = 0, _a = manager.ingredients; _i < _a.length; _i++) {
        ...
        if (item.inStock == false) {
            document.getElementById("ingrediantsToBuy").innerHTML += "\n     <div class=\"border-bottom row\"> <li class=\"list-group-item d-inline-block w-50 col-6 align-self-center ingredaint-item\">".concat(item.name, ", ").concat(item.amount, "</li> <span class=\"col-sm-6 d-flex justify-content-center\"> <button class=\"btn btn-success mx-3 my-2\" onclick=\"completeTask(").concat(item.id, ")\"><i class=\"fa-solid fa-check\"></i></button><button class=\"btn btn-danger mx-3 my-2\" onclick=\"deleteTask(").concat(item.id, ")\"><i class=\"fa-solid fa-trash\"></i></button></span> </div> ");
        }
        else {
